...
**🔴 Live: [ponsscan.xyz](https://ponsscan.xyz)** · 🎓 [Graduation alerts on Telegram](https://t.me/ponsscan) · 𝕏 [@pons_scan](https://x.com/pons_scan)
...
- **👑 Creator leaderboard** — the deployers whose graduates actually hold up (quality-ranked: survival of their graduates weighted in, factories excluded) and, on the other tab, the token factories of the day
- **🕵️ Deep checks** — creator wallet age, the wallet that first funded it and how many *other* recent deployers that same funder seeded (sybil clusters), the creator's own allocation (bought / sold / burned), holder concentration (top holder, top-10, contracts excluded), launch-window buyers with an insider-bundle check (early buyers funded by the creator or the creator's funder), and the outcomes of the creator's previous graduates — each one a transparent, weighted score factor.
